...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gexp incoming peers (TCP:42786)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gexp\unpacked\gexp.exe" "" "" "Expanse" 42786 "" "" ""
    #SimpleFC::AdvAddRule "Gexp outgoing peers (TCP:42786)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gexp\unpacked\gexp.exe" "" "" "Expanse" "" 42786 "" ""
    #SimpleFC::AdvAddRule "Gexp UDP discovery (UDP:42786)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gexp\unpacked\gexp.exe" "" "" "Expanse" "" 42786 "" ""
